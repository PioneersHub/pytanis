...
To run `notebooks/pyconde-pydata-darmstadt-2026/50_write_schedule_to_pretalx_v1.ipynb`, complete the standard setup in [Getting started](#getting-started) (Pretalx token + Google credentials). Then additionally:
